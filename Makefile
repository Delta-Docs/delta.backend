help:
	...
	@echo "  migrate       Generate a new migration (usage: make migrate m=\"message\")"
	@echo "  upgrade       Apply all migrations"
	@echo "  upgrade-one   Apply one migration step"
	@echo "  downgrade     Downgrade one migration step"
